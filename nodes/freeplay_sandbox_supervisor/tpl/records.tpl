            ...
            <h3>New record</h3> {{ freespace }}
                ...
                <div id="prod_quiz" class="center row" style="display:none;">
                    ...
                    <ul id='encourage-level3' class='dropdown-content'>
                      <li><a href="#!" onclick="perform('quiz_encourage', {'encourage':'3:none, Luh noo nour, est?'})">Nounours</a></li>
                    ...
                    <ul id='question-hint' class='dropdown-content'>
                      ...
                      <li><a href="#!" onclick="perform('quiz_question_hint', {'hint':'animated, Lets move to the next question'})">Next</a></li>
                    </ul>
                    ...
                    <p id="score-info" style="display:none">Quiz Score:<br>
                      ...
                      <a id="score-child" class="col s1">
                        <input type="number"  id="score-child-input" min="0" max="99" step="1" value="0" onchange="perform('quiz_uscore', {'uscore':this.value})">
                      </a>
                      ...
                      <a id="score-robot" class="col s1">
                        <input type="number"  id="score-robot-input" min="0" max="99" step="1" value="0" onchange="perform('quiz_ascore', {'ascore':this.value})">
                      </a>
...
function reset() {
    ...
    $('#score-child-input').val(0);
    $('#score-robot-input').val(0);
